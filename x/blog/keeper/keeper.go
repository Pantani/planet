...
func NewKeeper(
	...
	k := Keeper{
		...
		SentPostSeq:    collections.NewSequence(sb, types.SentPostCountKey, "sentPost"),
		SentPost:       collections.NewMap(sb, types.SentPostKey, "sentPost_seq", collections.Uint64Key, codec.CollValue[types.SentPost](cdc)),
		TimeoutPostSeq: collections.NewSequence(sb, types.TimeoutPostCountKey, "timeoutPost"),
		TimeoutPost:    collections.NewMap(sb, types.TimeoutPostKey, "timeoutPost_seq", collections.Uint64Key, codec.CollValue[types.TimeoutPost](cdc)),
...
func (k Keeper) BindPort(ctx sdk.Context, portID string) error {
	...
	fmt.Printf("\n\n******** ClaimCapability BindPort Path:%s \nportID:%s \n\n\n\n", host.PortPath(portID), portID)
