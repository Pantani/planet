...
func init() {
	...
	md_TimeoutPost = File_planet_blog_v1_timeout_post_proto.Messages().ByName("TimeoutPost")
...
func (x *TimeoutPost) slowProtoReflect() protoreflect.Message {
	mi := &file_planet_blog_v1_timeout_post_proto_msgTypes[0]
...
func (x *fastReflection_TimeoutPost) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "planet.blog.v1.TimeoutPost.id":
		return x.Id != uint64(0)
	case "planet.blog.v1.TimeoutPost.title":
		return x.Title != ""
	case "planet.blog.v1.TimeoutPost.chain":
		return x.Chain != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: planet.blog.v1.TimeoutPost"))
		}
		panic(fmt.Errorf("message planet.blog.v1.TimeoutPost does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TimeoutPost) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message planet.blog.v1.TimeoutPost does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TimeoutPost) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "planet.blog.v1.TimeoutPost.id":
		panic(fmt.Errorf("field id of message planet.blog.v1.TimeoutPost is not mutable"))
	case "planet.blog.v1.TimeoutPost.title":
		panic(fmt.Errorf("field title of message planet.blog.v1.TimeoutPost is not mutable"))
	case "planet.blog.v1.TimeoutPost.chain":
		panic(fmt.Errorf("field chain of message planet.blog.v1.TimeoutPost is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: planet.blog.v1.TimeoutPost"))
		}
...
func (x *fastReflection_TimeoutPost) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in planet.blog.v1.TimeoutPost", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TimeoutPost) Descriptor() ([]byte, []int) {
	return file_planet_blog_v1_timeout_post_proto_rawDescGZIP(), []int{0}
}
...
var File_planet_blog_v1_timeout_post_proto protoreflect.FileDescriptor

var file_planet_blog_v1_timeout_post_proto_rawDesc = []byte{
	0x0a, 0x21, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x74, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x76, 0x31,
	0x2f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x74, 0x2e, 0x62, 0x6c, 0x6f, 0x67,
	0x2e, 0x76, 0x31, 0x22, 0x49, 0x0a, 0x0b, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x50, 0x6f,
	...
	,
}

var (
	file_planet_blog_v1_timeout_post_proto_rawDescOnce sync.Once
	file_planet_blog_v1_timeout_post_proto_rawDescData = file_planet_blog_v1_timeout_post_proto_rawDesc
)

func file_planet_blog_v1_timeout_post_proto_rawDescGZIP() []byte {
	file_planet_blog_v1_timeout_post_proto_rawDescOnce.Do(func() {
		file_planet_blog_v1_timeout_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_planet_blog_v1_timeout_post_proto_rawDescData)
	})
	return file_planet_blog_v1_timeout_post_proto_rawDescData
}

var file_planet_blog_v1_timeout_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_planet_blog_v1_timeout_post_proto_goTypes = []interface{}{
	(*TimeoutPost)(nil), // 0: planet.blog.v1.TimeoutPost
}
var file_planet_blog_v1_timeout_post_proto_depIdxs = []int32{
...
func init() { file_planet_blog_v1_timeout_post_proto_init() }
func file_planet_blog_v1_timeout_post_proto_init() {
	if File_planet_blog_v1_timeout_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_planet_blog_v1_timeout_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_planet_blog_v1_timeout_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_planet_blog_v1_timeout_post_proto_goTypes,
		DependencyIndexes: file_planet_blog_v1_timeout_post_proto_depIdxs,
		MessageInfos:      file_planet_blog_v1_timeout_post_proto_msgTypes,
	}.Build()
	File_planet_blog_v1_timeout_post_proto = out.File
	file_planet_blog_v1_timeout_post_proto_rawDesc = nil
	file_planet_blog_v1_timeout_post_proto_goTypes = nil
	file_planet_blog_v1_timeout_post_proto_depIdxs = nil
}
